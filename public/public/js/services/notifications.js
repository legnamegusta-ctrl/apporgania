...
import { onSnapshot, collection, query, where, orderBy, doc, updateDoc } from 'https://www.gstatic.com/firebasejs/9.6.0/firebase-firestore.js';
...
export function setupNotifications(userId) {
    ...
    notificationsListener = onSnapshot(q, (snapshot) => {
        ...
        // REMOVIDO "document" do parâmetro do forEach. Agora 'document' global é acessado corretamente.
