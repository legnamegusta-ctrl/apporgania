...
export function initFormulasAdmin(userId, userRole) {
  ...
  function openFormulaModal(formula = null) {
    if (!formulaModal || !formulaModalTitle || !formulaNameInput) return
  ...
  async function saveFormula() {
    if (!formulaNameInput || !saveFormulaBtn) return
  ...
  if (showAddFormulaModalBtn) showAddFormulaModalBtn.addEventListener("click", () => openFormulaModal())
  if (closeFormulaModalBtn) closeFormulaModalBtn.addEventListener("click", () => closeModal(formulaModal))
